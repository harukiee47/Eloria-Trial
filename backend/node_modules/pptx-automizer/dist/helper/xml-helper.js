...
class XmlHelper {
    ...
    static findByElementName(archive, path, name, nameIdx) {
        return __awaiter(this, void 0, void 0, function* () {
            const slideXml = yield XmlHelper.getXmlFromArchive(archive, path);
            return XmlHelper.findByName(slideXml, name, nameIdx);
        });
    }
    static findByName(doc, name, nameIdx) {
    ...
    static appendSharedString(sharedStrings, stringValue) {
        ...
        const newLabel = sharedStrings.createTextNode(XmlHelper.sanitizeText(stringValue));
...
XmlHelper.removeByTagName = (element, tagName, i = 0) => {
