...
exports.MultiTextHelper = void 0;
...
class MultiTextHelper {
     ...
     */
    clearExistingParagraphs(txBody) {
        const existingParagraphs = txBody.getElementsByTagName('a:p');
     ...
     */
    createParagraphs(txBody, paragraphs, defaultStyle = {}) {
    ...
    mergeStyles(defaultStyle = {}, customStyle = {}) {
        return Object.assign(Object.assign({}, defaultStyle), customStyle);
    }
    /**
    ...
    applySpacingProperties(pPr, paragraphProps) {
        ...
        if (paragraphProps.lineSpacing !== undefined) {
            ...
            spcPts.setAttribute('val', String(Math.round(paragraphProps.lineSpacing * 100))); // Convert to 100ths of a point
        ...
        if (paragraphProps.spaceBefore !== undefined) {
            ...
            const spcPts = this.document.createElement('a:spcPts');
            spcPts.setAttribute('val', String(Math.round(paragraphProps.spaceBefore * 100))); // Convert to 100ths of a point
        ...
        if (paragraphProps.spaceAfter !== undefined) {
            ...
            const spcPts = this.document.createElement('a:spcPts');
            spcPts.setAttribute('val', String(Math.round(paragraphProps.spaceAfter * 100))); // Convert to 100ths of a point
     ...
     */
    createSingleTextRun(p, text, style) {
        const textString = String(text || '');
        // Check if this text run needs a hyperlink
        if ((style === null || style === void 0 ? void 0 : style.hyperlink) && this.relationElement) {
     ...
     */
    createHyperlinkTextRun(p, text, style) {
     ...
     */
    createRelationshipData(target, isInternal) {
        if (isInternal) {
            return {
     ...
     */
    addRelationship(relation, relData) {
...
exports.MultiTextHelper = MultiTextHelper;
//# sourceMappingURL=multitext-helper.js.map