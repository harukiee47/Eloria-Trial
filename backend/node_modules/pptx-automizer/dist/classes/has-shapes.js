...
const diagram_1 = require("../shapes/diagram");
...
class HasShapes {
    ...
    getSlideHelperInstance(archive, path, number) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Retrieve the slide XML data
                const slideXml = yield xml_helper_1.XmlHelper.getXmlFromArchive(archive, path);
                const sourceLayoutId = yield xml_relationship_helper_1.XmlRelationshipHelper.getSlideLayoutNumber(archive, number);
    ...
    getUniqueImportedElements() {
        return __awaiter(this, void 0, void 0, function* () {
            for (const element of this.importElements) {
                ...
                const alreadyImported = this.importElements.find((ele) => { var _a; return ((_a = ele.info) === null || _a === void 0 ? void 0 : _a.hash) === eleHash; });
                if (alreadyImported) {
