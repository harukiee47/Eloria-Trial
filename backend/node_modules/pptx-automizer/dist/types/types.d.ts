...
export type ShapeModificationCallback = (element: XmlElement, relation?: XmlElement, info?: ElementInfo) => void;
 ...
 */
export declare function getMediaBuffer(file: MediaFile, fsReadFileSync: (path: string) => Buffer): Buffer;
...
export type FindElementSelector = string | FindElementMultiSelector;
