    ...
    constructor(chart, workbook, data, slot) {
        this.setSeriesDataLabels = () => {
            this.data.series.forEach((series, s) => {
                var _a, _b, _c;
                if ((_a = series.style) === null || _a === void 0 ? void 0 : _a.label) {
            ...
            if (category.styles) {
                category.styles.forEach((style, s) => {
                    if (style === null || !Object.values(style).length)
                        return;
                    this.chart.modify(this.series(s, this.chartPoint(c, c, style)));
                    if (style.label) {
                        this.chart.modify(this.series(s, this.chartPointLabel(c, c, style.label)));
                    }
                });
            }
        });
