 ...
 */
const VALID_MEDIA_EXTENSIONS = Object.keys(content_type_map_1.ContentTypeMap);
/**
...
function validateMediaExtension(extension, filename) {
    if (!VALID_MEDIA_EXTENSIONS.includes(extension.toLowerCase())) {
        throw (`Unsupported media extension '${extension}' for file '${filename}'. ` +
    ...
    writeMediaFiles() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const file of this.rootTemplate.mediaFiles) {
                const data = (0, types_1.getMediaBuffer)(file, fs.readFileSync);
